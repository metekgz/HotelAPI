...
namespace Persistence.Migrations
{
    ...
    [Migration("20230714095532_mig_11")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.HotelProduct", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("HotelProducts");
                });

            modelBuilder.Entity("Domain.Entities.HotelProductItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("HotelProductId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("HotelProductId");

                    b.HasIndex("ProductId");

                    b.ToTable("HotelProductItems");
                });
            ...
            modelBuilder.Entity("Domain.Entities.HotelProductItem", b =>
                {
                    b.HasOne("Domain.Entities.HotelProduct", "HotelProduct")
                        .WithMany("HotelProductItems")
                        .HasForeignKey("HotelProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.Room", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.HotelProduct", "HotelProduct")
                        .WithOne("Room")
                        .HasForeignKey("Domain.Entities.Room", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.HotelProduct", b =>
                {
                    b.Navigation("HotelProductItems");
